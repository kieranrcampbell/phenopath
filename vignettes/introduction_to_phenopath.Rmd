...
Alternatively you might have expression values in an `SingleCellExperiment`. For single-cell data it is highly recommended to use the [scater](https://bioconductor.org/packages/release/bioc/html/singlecellexperiment.html)  in which case data is stored in a class derived from `SummarizedExperiment`.
